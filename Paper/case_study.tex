...
\end{tikzpicture}
\caption{Gridworld where agent in blue has to reach green target cell without crashing into the red static obstacles or the orange moving obstacle.}\label{fig:exp1}
\end{figure}
